...
class ProbBasedSampling(object):
...
class ProbBasedSampling_poolbased(object):
    def __init__(self, num_query):
        super(EntropyUncertainty_poolbased, self).__init__()
        self.num_query = num_query
        self.entropy = Entropy()

    def query(self, data_loader, fasterRCNN, pool):
        ...
        # save queries
        with open('low_prob_queries.txt', 'w') as f:
